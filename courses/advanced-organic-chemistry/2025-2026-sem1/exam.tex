...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.4\textwidth]{q1}
\end{figure}
\vspace*{-0.5em}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.35\textwidth]{q2}
\end{figure}
...
\begin{enumerate}
	\item 写出括号中物质的结构。其中$R$为大位阻烷基\\
		\begin{minipage}[h]{1\textwidth}
			\vspace{1em}
			\centering
			\includegraphics[width=0.5\textwidth]{q3-1}
		\end{minipage}
   		\vspace{1em}
	...
	\item 写出括号中物质的结构\\
		\begin{minipage}[h]{1\textwidth}
   		 	\vspace{1em}	
			\centering
			\includegraphics[width=0.7\textwidth]{q3-2}
		\end{minipage}
		\vspace{1em}
	...
	\item 写出括号中物质的结构\\
		\begin{minipage}[h]{1\textwidth}
			\vspace{1em}	
			\centering
			\includegraphics[width=0.6\textwidth]{q3-3}
		\end{minipage}
		\vspace{1em}
	...
	\item 按照稳定性顺序排序下列物质\\
		\begin{minipage}[h]{1\textwidth}
			\vspace{1em}	
			\centering
			\includegraphics[width=0.7\textwidth]{q3-4}
		\end{minipage}
		\vspace{1em}
	...
	\item 写出括号中物质的结构\\
		\begin{minipage}[h]{1\textwidth}
			\vspace{1em}	
			\centering
			\includegraphics[width=0.7\textwidth]{q3-5}
		\end{minipage}
		\vspace{1em}
	...
	\item 写出括号中物质的结构\\
		\begin{minipage}[h]{1\textwidth}
			\vspace{1em}	
			\centering
			\includegraphics[width=0.48\textwidth]{q3-6}
		\end{minipage}
		\vspace{1em}
	...
	\item 写出括号中物质的结构\\
		\begin{minipage}[h]{1\textwidth}
			\vspace{1em}	
			\centering
			\includegraphics[width=0.9\textwidth]{q3-7}
		\end{minipage}
		\vspace{1em}
	...
	\item 写出括号中物质的结构\\
		\begin{minipage}[h]{1\textwidth}
			\vspace{1em}	
			\centering
			\includegraphics[width=0.45\textwidth]{q3-8}
		\end{minipage}
		\vspace{1em}
...
\begin{postulate*}
	\vspace{0.2em}
	\hspace{2em}本回忆版试题主要由应化专业的藤原妹红同学制作。感谢应化专业的硫化锆ZrS和$\alpha$-H两位同学帮助补充完善了第三大题。感谢~Elegant\LaTeX{} Program。
