...
\begin{quotation}
	...
	本回忆版试题由24级应用化学（拔尖班）制作。感谢张润森和张永祺同学帮助补充完善了第三大题，感谢~Elegant\LaTeX{} Program。
	...
	本回忆版试题的原始$.tex$文件已开源至\href{}{Github}。如本试题中有不准确的地方，欢迎各位补充指正。
...
\begin{postulate*}
	\vspace{0.2em}
	\hspace{2em}本资料旨在让备考的同学们了解考试难度，心里有个底。不要指望着写完这套卷子就能稳了，还请认真复习。因难度较低，故不提供答案，自行查书即可。另外，请勿将本习题泄露给老师或学院，否则可能导致你自己的期末题目变得不可预测。
	
	\hspace{2em}虽然老师说不会捞人，但是实际上考试内容大多为课程原题，好好听课就不可能挂科。
	
	\hspace{2em}整理者在此由衷建议各位日后希望从业于有机化学的读者认真学习高等有机化学。个人感觉，本课程的期末考试内容仅为课程内容的一点零头，考试甚至还没有有机化学G的小测难度高。如果要成为一名训练有素的有机化学家，仅仅通过了本课程的期末考试是远远不够的。
	
	\hspace{2em}建议完成时间：<~45min.
\end{postulate*}
